...
function themename_customize_register($wp_customize) {
    ...
    $wp_customize->add_setting('oy_secondary_logo');
	
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'oy_sec_logo', array(
        'label'   => __('Secondary Logo (menu section)', 'onioneye'),
        'section' => 'title_tagline',
        'settings'   => 'oy_secondary_logo',
    ) ) );
    
    $wp_customize->add_setting('oy_is_logo_retina');
    
    $wp_customize->add_control('oy_retina_ready', array(
	    'label'    => __('Make the logos retina ready? (This will &quot;squash&quot; the logo in half to make it look crisp on retina devices)', 'onioneye'),
	    'section'  => 'title_tagline',
	    'type'     => 'checkbox',
    ...
    $wp_customize->add_section( 'oy_contact_details', array(
	    'title'          => __( 'Contact Details', 'onioneye' ),
	    'priority'       => 40,
	)); 
	...
	$wp_customize->add_setting('oy_address');
    
    $wp_customize->add_control('oy_ctrl_address', array(
	    'label'    => __('Address', 'onioneye'),
	    'section'  => 'oy_contact_details',
	    'type'     => 'text',
		'settings' => 'oy_address',
	) );
