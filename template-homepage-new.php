...
<div class="welcome">
    ...
    <div class="packery">
        <div class="grid"> <!-- start packery -->
          <div class="grid-item width-1"><img src="<?php bloginfo('template_directory'); ?>/images/image1.jpg" /></div>
          ...
          <div class="grid-item width-5"><img src="<?php bloginfo('template_directory'); ?>/images/image5.jpg" /></div>
		   <div class="grid-item width-7"><img src="<?php bloginfo('template_directory'); ?>/images/image7.jpg" /></div>
